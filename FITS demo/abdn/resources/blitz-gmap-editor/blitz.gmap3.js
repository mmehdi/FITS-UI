...
var BlitzMap = new function(){
    ...
    this.init = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng( 57.5028, -2.5268 ),
            zoom: 5,
    ...
    function setMapData( jsonString ){
        ...
        if( inputData.mapTypeId ){
            ...
            mapObj.setMapTypeId( "TERRAIN" );  // the default map type Id
        }

        if( inputData.center ){
            mapObj.setCenter( new google.maps.LatLng( inputData.center.lat, inputData.center.lng ) );
        }else{
            mapObj.setCenter( new google.maps.LatLng( 57.5028, -2.5268 ) );
        }
